...
const ASTRONOMICAL_PUZZLES = [
  ...
  },
  {
    ...
    prompt: "A domed ceiling, floor mosaic, or standing-stone circle is covered in carved stars, and the party must press or align the correct cluster to match a constellation an NPC astronomer, sailor, or druid described earlier as [the constellation you named — e.g., the Serpent, the Second Flame, the Huntress's Bow]. Scattered among the correct stars are decoy clusters that almost, but don't quite, match the description.",
